...
class IndividualMemberAccessTokenAuthenticator extends AbstractGuardAuthenticator
{
...
//            && $request->isMethod('POST');
        return !empty($request->request->get('access-token'))
            && $request->isMethod('POST');
    }
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (empty($user)) {
            ...
            throw new \Exception('aaaaaaaaaaaaaaaaaaaa '.json_encode($credentials));
