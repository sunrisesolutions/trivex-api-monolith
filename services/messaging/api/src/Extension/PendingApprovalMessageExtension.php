...
final class PendingApprovalMessageExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    private $security;
...
//        echo $queryBuilder->getQuery()->getSQL();
    ...
    {
        return in_array($class, [Message::class]);
    }
}
